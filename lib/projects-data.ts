...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    status: 'in-build',
    tagline: 'Leading team building trader-native Android OS',
    description: 'Leading development team building custom Android OS for Web3 traders on native hardware. Currently called PumpOne.',
    fullDescription: [
      'Leading the development team building a trader-native Android operating system designed from the ground up for Web3 trading on native hardware.',
      'Custom OS architecture optimized for real-time trading, portfolio management, and blockchain interactions. Currently operating under the PumpOne brand.',
      'Building the infrastructure and tooling to enable seamless trading experiences with hardware-level optimizations.',
    ],
